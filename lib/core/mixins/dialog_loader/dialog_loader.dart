...
mixin DialogLoader <e extends StatefulWidget> on State<e> {
 ...
 void dialogLocationPermissionDenied(VoidCallback onPositiveButton ){
      ...
      builder: (alertContext){
         return  AlertDialog(
          content: const Text('Perciasamos da sua localizaão para realizar a melhor rota para sua viagem'),
          actions: [
 ...
 void dialogLocationPermissionDeniedForeve(VoidCallback onPositiveButton ){
      ...
      builder: (alertContext){
         return  AlertDialog(
          content: const Text('Perciasamos da sua localizaão para realizar a melhor rota para sua viagem  assim voc^poderá ter uma melhor experiência ao utlilizar o Uber'),
          actions: [
             TextButton(onPressed: (){
               Navigator.pop(context);
             }, child: const Text('Não Permitir')),
